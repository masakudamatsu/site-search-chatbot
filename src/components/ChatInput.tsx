  ...
  return (
    ...
    >
      <input
        ...
        disabled={isLoading}
        className="w-full rounded-full border-2 border-gray-600 bg-gray-700 p-4 pr-16 text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-40"
      />
      {!isLoading ? (
        <button
          type="submit"
